// glaive
function GlaiveClass(type, owner) {
...
GlaiveClass.prototype.attack = function() {
    ...
    var projectile = new StraightProjectileClass({x: this.x, y: this.y}, {x: this.targets[0].x, y: this.targets[0].y}, projectilePics[this.type][0], this.type, dmg, speed, hits, this.tier, true, this.id, this.owner);
